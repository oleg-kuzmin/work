...
- Cвойство __proto__ принадлежит объекту, свойство prototype — функции-конструктору.

- Процесс поиска свойства в объекте будет таким:
1. Вы обращаетесь к свойству объекта, которого у того нет.
2. Движок, не найдя нужного свойства, не прекращает поиски, а заглядывает в свойство __proto__: если здесь хранится ссылка на другой объект, движок будет искать нужное свойство у него.
*/
