...
//*16  VALUE--  (постфиксный декремент) (уменьшает переменную на 1, аналогично value = value - 1, => старое значение)
//*15  ++VALUE  (префиксный инкремент)  (увеличивает переменную на 1, аналогично value + 1 = value, => новое значение)
//*15  --VALUE  (префиксный декремент)  (уменьшает переменную на 1, аналогично value - 1 = value, => новое значение)
...
- Специальное правило: (null == undefined) // true (Эти значения равны друг другу и не равны никаким другим значениям)
*/
