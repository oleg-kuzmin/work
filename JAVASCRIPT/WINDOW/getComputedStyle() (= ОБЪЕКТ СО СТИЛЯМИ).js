...
//# Синтаксис
//* 1. element (Элемент, значения для которого нужно получить)

//* 2. pseudo (Указывается, если нужен стиль псевдоэлемента, например ::before). Пустая строка или отсутствие аргумента означают сам элемент.
