...
// TODO Скобки. Чтобы разделить код и вёрстку, рекомендуется обрамлять JSX в круглые скобки:
ReactDOM.render((
  <h1>
    I Want To Believe 🛸
  </h1>
...
// Чтобы JSX-код работал правильно, мы «оборачиваем» элементы во фрагмент.
// <React.Fragment>...</React.Fragment> или его более ёмкий вариант <>...</>.
ReactDOM.render((
  <>
...
// Оператор && (логическое И) — аналог if, но без else — используется, если нужно отобразить часть JSX разметки только при определённом условии,
// в противном случае вообще ничего не отображать:
ReactDOM.render((
  <div>
...
// TODO Свойства элементов
// Для задания CSS-класса вместо class используется атрибут className:
ReactDOM.render((
  <div>
