...
// Сервер по-прежнему может сообщать клиенту об ошибках или проблемах в самом потоковом контенте, например, при использовании redirect или notFound. Поскольку заголовки ответа уже отправлены клиенту, код состояния ответа не может быть обновлен. Это не влияет на SEO.
