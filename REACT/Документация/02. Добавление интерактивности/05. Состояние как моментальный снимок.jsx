...
// Значение переменной состояния никогда не меняется во время рендеринга, даже если код обработчика события асинхронный. Внутри этого рендера onClick, значение number продолжает быть 0 даже после вызова setNumber(number + 5). Его значение было "зафиксировано", когда React "сделал снимок" пользовательского интерфейса, вызвав ваш компонент.
