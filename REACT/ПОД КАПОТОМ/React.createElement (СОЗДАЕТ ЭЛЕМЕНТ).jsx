...
//* 2. Объект: дополнительные свойства, которые прикреплены к этому тегу. Например CSS-идентификатор class или id либо другие.
//* 3. Содержимым, которое попадёт в HTML-тег. Содержимым может быть не только текст, но и другие элементы или массив.
