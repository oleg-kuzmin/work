...
// Нет ничего плохого в повторяющемся коде — он может быть более разборчивым. Но иногда вы можете оценить краткость. Некоторые компоненты передают ВСЕ свои props своим дочерним элементам, например, как Profile с Avatar. Поскольку они не используют никакие свои props напрямую, может иметь смысл использовать более краткий синтаксис «расширения»:
