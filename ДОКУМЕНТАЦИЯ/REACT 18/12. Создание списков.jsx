...
- Локально сгенерированные данные: если ваши данные создаются и сохраняются локально (например, заметки в приложении для создания заметок), используйте увеличивающийся счетчик crypto.randomUUID() или пакет, например, uuid при создании элементов.
*/
