...
// Теперь предположим, что вы хотите поместить текст завершенного элемента в другой HTML-тег, например, <del>зачеркнуть его. Вы можете добавить еще больше новых строк и круглых скобок, чтобы было проще вкладывать больше JSX в каждом из случаев:
