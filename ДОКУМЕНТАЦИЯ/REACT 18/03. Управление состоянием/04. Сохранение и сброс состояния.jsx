...
// Когда вы ставите или снимаете флажок, состояние счетчика не сбрасывается. Независимо от того , isFancyis trueили false, у вас всегда есть a <Counter />как первый дочерний элемент, возвращенный divиз корневого Appкомпонента:
