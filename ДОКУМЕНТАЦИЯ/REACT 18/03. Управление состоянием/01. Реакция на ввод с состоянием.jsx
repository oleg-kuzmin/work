...
//# Резюме
// Декларативное программирование означает описание пользовательского интерфейса для каждого визуального состояния, а не микроуправление пользовательским интерфейсом (императив).

/*
При разработке компонента:

1. Определите все его визуальные состояния.
2. Определите триггеры человека и компьютера для изменения состояния.
