...
//# Шаг 1. Запуск рендеринга (тригер)
...
// После того, как рендеринг завершен и React обновил DOM, браузер перерисует экран. Хотя этот процесс известен как «рендеринг в браузере», мы будем называть его «рисованием (отрисовкой)», чтобы избежать путаницы в документации.

//# Резюме
/*
- Любое обновление экрана в приложении React происходит в три этапа:
1. Тригер, запуск рендеринга
2. Сам рендеринг
3. Коммит в dom

- Вы можете использовать строгий режим для поиска ошибок в ваших компонентах.
- React не затрагивает DOM, если результат рендеринга такой же, как и в прошлый раз.
*/
