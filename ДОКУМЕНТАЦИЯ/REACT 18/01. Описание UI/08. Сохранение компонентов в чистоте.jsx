...
- Он думает о своем собственном бизнесе. Он не должен изменять какие-либо объекты или переменные, существовавшие до рендеринга.
- Те же входы, тот же выход. При одинаковых входных данных компонент всегда должен возвращать один и тот же JSX.
...
- Вы не должны изменять какие-либо входные данные, которые ваши компоненты используют для рендеринга. Это включает свойства, состояние и контекст. Чтобы обновить экран, «установите» состояние вместо изменения ранее существовавших объектов.
- Стремитесь выразить логику вашего компонента в возвращаемом JSX. Когда вам нужно «что-то изменить», обычно вы хотите сделать это в обработчике событий. В крайнем случае можно useEffect.
