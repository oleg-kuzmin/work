...
/*
- Фактически это синтаксическая надстройка над promise.
- Асинхронная функция всегд возвращает promise.
- Await ждет пока состояние promise изменится с pending на fulfilled или rejected.
