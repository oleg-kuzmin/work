...
- Если внутри функции (компонента) вызвать внешнюю функцию (например хук), то она может изменить значение переменной внутри и уже не быть чистой, такие функции называются функции с побочным эффектом.

- Именование компонентов: PascalCase
- Именование известных переменных (например адрес хоста): DB_HOST
*/
