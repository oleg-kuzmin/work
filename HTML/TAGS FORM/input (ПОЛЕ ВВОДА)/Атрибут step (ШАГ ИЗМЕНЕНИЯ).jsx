...
1. date, значение по умолчанию 1 день;
2. month, значение по умолчанию 1 месяц;
3. week, значение по умолчанию 1 неделя;
4. time, значение по умолчанию 60 секунд;
5. datetime-local, значение по умолчанию 1 секунда;
6. number, значение по умолчанию 1;
7. range, значение по умолчанию 1.
...
1. min — устанавливает минимальное значение диапазона;
2. max — устанавливает максимальное значение диапазона.
*/
