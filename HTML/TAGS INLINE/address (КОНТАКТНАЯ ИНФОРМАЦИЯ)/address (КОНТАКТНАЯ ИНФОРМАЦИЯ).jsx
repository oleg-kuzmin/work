//# address (КОНТАКТНАЯ ИНФОРМАЦИЯ) (address: адрес)
/*
...
2. Нельзя вкладывать в параграф с текстом, это не фразовый элемент.
3. Внутри нельзя использовать заголовки, секционные теги (<section>, <article>, <aside>, <nav>), а также теги <header> и <footer>.
