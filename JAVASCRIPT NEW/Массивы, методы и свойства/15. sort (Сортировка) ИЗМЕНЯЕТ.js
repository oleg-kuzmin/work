//# .sort()
// Cортирует массив по возрастанию, убыванию и вообще как угодно.
...
//# общая информация
/*
- Метод sort принимает на вход колбэк. Но для других методов колбэк обязателен, а для sort нет. Метод sort, если не передавать ему аргументы, пытается сортировать элементы массива по возрастанию этих кодов.
- На практике метод sort редко вызывают без аргументов. По двум причинам:
1) нам не всегда нужна сортировка по возрастанию
2) нам точно не нужно сортировать числа как строки
