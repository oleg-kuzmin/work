//# .substring() (Возвращает часть строки).js
/*
...
- Метод принимает один или два аргумента.
- При вызове с двумя аргументами нужно передать индекс символа, с которого начинать копирование и индекс символа, на котором закончить.
