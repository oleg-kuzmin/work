...
//# общая информация
/*
- Объект — это коллекция пар ключ-значение. Ключи в большинстве случаев — строки. Даже если мы пытаемся записать ключ (или обратиться к нему), который не является строкой, он автоматически будет преобразован к строчному типу. Значениями могут быть данные любых типов.
...
- Если же в переменные записаны ссылки на объекты, движок сравнивает не их содержимое, а проверяет, на один ли объект ведут ссылки. Если на один, то возвращает true, если на разные — false.
